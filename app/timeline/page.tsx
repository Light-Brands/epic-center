...
const MILESTONES: Milestone[] = [
  {
    ...
    description: 'Close $13.4M equity raise for foundation-year 15-casita campus',
    status: 'in-progress',
  ...
  },
  {
    id: 'foundation-year',
    date: 'Q4 2026',
    title: 'Foundation Year Complete',
    description: '15 casitas proven, clinical model validated, data collection underway',
    status: 'upcoming',
    category: 'launch',
  },
  {
    id: 'year2-expansion',
    date: '2027',
    title: 'Year 2: Expand to 30 Casitas',
    description: 'Add 15 casitas funded from operating cash flow. Villa pre-sales begin.',
    status: 'upcoming',
    category: 'construction',
  },
  {
    id: 'year3-expansion',
    date: '2028',
    title: 'Year 3: Expand to 45 Casitas',
    description: 'Add 15 casitas. 10 villas operational. Revenue ~$25.7M.',
    status: 'upcoming',
    category: 'construction',
  },
  {
    ...
    description: 'All 60 casitas operational. 48 villas complete. Revenue ~$42M.',
    status: 'upcoming',
    category: 'launch',
  },
]
...
const PHASES = [
  {
    ...
    items: ['Close $13.4M equity raise', 'Acquire property', 'Convert first 15 casitas', 'First patients'],
  },
  {
    name: 'Phase 2: Foundation Year',
    period: 'Q3–Q4 2026',
    icon: Building2,
    color: 'bg-primary-500',
    items: ['Operate 15 casitas at 60% occ.', 'Validate clinical model', 'Build data collection systems'],
  },
  {
    name: 'Phase 3: Scale & Expand',
    period: '2027–2028',
    icon: Heart,
    color: 'bg-secondary-400',
    items: ['Expand 15 → 30 → 45 casitas', 'Villa sales begin Year 2', 'Revenue reaches ~$26M'],
  },
  {
    ...
    items: ['60 casitas operational', '48 villas complete', 'Revenue ~$42M Year 5'],
  },
]

const ANNUAL_PROJECTIONS = [
  { year: 'Year 1', revenue: '$7.8M', rooms: '15', guests: '253', occupancy: '60%', ebitda: '$0.7M' },
  { year: 'Year 2', revenue: '$14.4M', rooms: '30', guests: '440', occupancy: '70%', ebitda: '$6.2M' },
  { year: 'Year 3', revenue: '$25.7M', rooms: '45', guests: '780', occupancy: '75%', ebitda: '$15.8M' },
  { year: 'Year 4', revenue: '$35.7M', rooms: '53', guests: '1,073', occupancy: '80%', ebitda: '$24.1M' },
  { year: 'Year 5', revenue: '$42.0M', rooms: '60', guests: '1,248', occupancy: '80%', ebitda: '$29.4M' },
]
          ...
          <Card padding="lg" className="bg-primary-800 text-white">
            ...
            >
              {[
                ...
                { date: 'Q4 2026', event: 'Foundation Year Complete', icon: Users },
              ].map((milestone, index) => (
