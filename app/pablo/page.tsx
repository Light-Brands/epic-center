...
const KEY_TERMS = [
  { label: 'Principal', value: '$10,000,000', icon: DollarSign },
      ...
      <div className="w-full sm:w-[70vw] mx-auto py-12 px-4 sm:px-0">
        ...
        <motion.section className="mb-24" {...fadeUp}>
          ...
          <Card padding="lg" className="bg-primary-50 border border-primary-200 mb-8">
            ...
            <p className="text-neutral-700 leading-relaxed">
              You lend <span className="font-medium">$10 million</span> at{' '}
        ...
        <motion.section className="mb-24" {...fadeUp}>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-neutral-100">
                  ...
                  <tr className="bg-canvas-emphasis font-medium">
                    ...
                    <td className="px-4 py-3 text-right text-neutral-900">$2,700,000</td>
                    <td className="px-4 py-3 text-right text-neutral-900">$10,000,000</td>
                    <td className="px-4 py-3 text-right text-primary-700">$12,700,000</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <MetricCard label="Total Interest" value="$2.7M" subtitle="Over 36 months" accent />
            <MetricCard label="Principal Returned" value="$10.0M" subtitle="At maturity" accent />
            <MetricCard label="Total to Lender" value="$12.7M" subtitle="27% gross return" accent />
          </div>
        </motion.section>
        ...
        <motion.section className="mb-24" {...fadeUp}>
          ...
          <p className="text-lg text-neutral-600 mb-8 max-w-3xl">
            Your $10 million sits behind a hard asset currently listed on
            Christie's International Real Estate at $11.9 million, with over
            $25 million of prior construction capital built into it. This is an
            84% loan-to-value position against the public listing, with the
            construction capital embedded as a replacement-cost backstop that
            sits beneath the market value.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <Card padding="lg" className="border border-primary-200">
              ...
              <p className="text-neutral-700 leading-relaxed">
                ...
                cenote pool, and full infrastructure. Your $10 million loan sits
                at 84% LTV against the listing price, with the construction
                capital as a replacement-cost backstop underneath.
              </p>
            </Card>
          ...
          <Card padding="lg" className="bg-neutral-900 text-white">
            ...
            <div className="grid sm:grid-cols-3 gap-6 text-center mb-6">
              ...
              <div>
                ...
                <p className="font-heading text-2xl text-secondary-400">$10,000,000</p>
              </div>
              <div>
                <p className="text-xs font-accent uppercase tracking-wider text-neutral-400 mb-1">
                  Loan-to-Value
                </p>
                <p className="font-heading text-2xl text-white">84%</p>
              </div>
            </div>
