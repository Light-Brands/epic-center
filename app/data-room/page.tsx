...
import { ArrowLeft, ArrowRight, FileText, Eye as EyeIcon, Lock, Folder, Mail, Sheet, ExternalLink } from 'lucide-react'
...
export default function DataRoomPage() {
  ...
  return (
    <VaultGate title="Investor Data Room" subtitle="Enter your 4-digit PIN to access confidential materials.">
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
