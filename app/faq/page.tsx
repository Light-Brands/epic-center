...
const FAQS: FAQ[] = [
  ...
  // Team
  {
    ...
    answer: 'Nicholas Courchesne (Founder/CEO) and Jason Sparks (Co-Founder/COO) lead the venture, supported by Dan Lawless as Technical Lead, a Chief Medical Advisor we are in private discussions with, and a growing team of dedicated professionals.',
  },
  {
    category: 'Team',
