...
export const metadata: Metadata = {
  ...
  description: 'A luxury medical retreat platform for deep healing through bio-optimization, plant medicine and trauma integration. $13.4M equity raise.',
  ...
  openGraph: {
    ...
    description: 'Luxury medical retreat at the convergence of psychedelic therapy and wellness tourism. $13.4M equity raise.',
