...
export const metadata: Metadata = {
  ...
  description: 'A luxury medical retreat platform for deep healing through bio-optimization, plant medicine and trauma integration. $17.3M equity raise.',
  ...
  openGraph: {
    ...
    description: 'Luxury medical retreat at the convergence of psychedelic therapy and wellness tourism. $17.3M equity raise.',
