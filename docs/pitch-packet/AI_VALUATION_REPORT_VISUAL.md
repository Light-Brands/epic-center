...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1a365d', 'primaryTextColor': '#fff', 'primaryBorderColor': '#2c5282', 'lineColor': '#4a5568', 'secondaryColor': '#38a169', 'tertiaryColor': '#ed8936'}}}%%
flowchart TB
    subgraph HEADER["🌟 TRANSFORMATIONAL EPICENTER"]
        direction TB
        V["<b>PRE-MONEY VALUATION</b><br/>$41,812,500"]
    ...
    subgraph PROPERTIES["DUAL PROPERTY STRATEGY"]
        direction LR
        P1["🏨 Hotel Alea Tulum<br/>HNW Flagship<br/>IRR: 29.54%"]
        P2["🏛️ Hacienda Caracol<br/>U-HNW Boutique<br/>IRR: 18.00%"]
    end

    HEADER --> METRICS
    METRICS --> PROPERTIES

    style HEADER fill:#f7fafc,stroke:#1a365d,stroke-width:2px
    style METRICS fill:#ebf8ff,stroke:#2c5282,stroke-width:1px
    style PROPERTIES fill:#f0fff4,stroke:#38a169,stroke-width:1px
    style M1 fill:#fff,stroke:#4a5568
    style M2 fill:#fff,stroke:#4a5568
    style M3 fill:#fff,stroke:#4a5568
    style M4 fill:#fff,stroke:#4a5568
    style P1 fill:#e6fffa,stroke:#319795,stroke-width:2px
    style P2 fill:#faf5ff,stroke:#805ad5,stroke-width:2px
```
...
flowchart TB
    subgraph THESIS["💡 INVESTMENT THESIS"]
        ...
        SOLUTION["💫 <b>THE SOLUTION</b><br/>First luxury medical wellness destination<br/>combining hospital care + 5-star hospitality +<br/>bio-optimization + plant medicine protocols"]

        OPPORTUNITY["🎯 <b>THE OPPORTUNITY</b><br/>$1T+ TAM | Category Creation<br/>No direct competitors | First-mover advantage"]

        RETURNS["📈 <b>THE RETURNS</b><br/>78% IRR | 7.8x MOIC<br/>$33M asset-backed floor valuation"]

        PROBLEM --> SOLUTION --> OPPORTUNITY --> RETURNS
    end

    style PROBLEM fill:#fed7d7,stroke:#c53030
    style SOLUTION fill:#c6f6d5,stroke:#276749
    style OPPORTUNITY fill:#ebf8ff,stroke:#2c5282
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#2c5282', 'secondaryColor': '#38a169'}}}%%
flowchart LR
    subgraph VALUATION["📊 VALUATION CONFIDENCE RANGE"]
        direction LR
        LOW["🔻 LOW<br/>$33.45M<br/><i>-20%</i>"]
        CENTRAL["⭐ CENTRAL<br/><b>$41.81M</b><br/><i>Base</i>"]
        HIGH["🔺 HIGH<br/>$58.54M<br/><i>+40%</i>"]

        LOW -.->|Conservative| CENTRAL
        CENTRAL -.->|Aggressive| HIGH
    end

    style LOW fill:#fed7d7,stroke:#c53030,stroke-width:2px
    style CENTRAL fill:#c6f6d5,stroke:#276749,stroke-width:3px
    style HIGH fill:#bee3f8,stroke:#2b6cb0,stroke-width:2px
```
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'pie1': '#1a365d', 'pie2': '#2c5282', 'pie3': '#38a169', 'pie4': '#ed8936'}}}%%
pie showData title Total Addressable Market Composition
    "Luxury Wellness Hospitality" : 850
    "Medical & Longevity Clinics" : 30
    "Biohacking & Performance" : 28
    "Plant Medicine & Psychedelics" : 4
```

```mermaid
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph TAM["🌍 MARKET OPPORTUNITY: $1T+ TAM"]
        direction TB
        T1["<b>Luxury Wellness</b><br/>$850B-$1.1T<br/>7-10% CAGR"]
        T2["<b>Medical Longevity</b><br/>$27-33B<br/>12-15% CAGR"]
        T3["<b>Biohacking</b><br/>$24-33B<br/>18-22% CAGR"]
        T4["<b>Plant Medicine</b><br/>$3-5B<br/>15-20% CAGR"]

        T1 & T2 & T3 & T4 --> TE

        TE["🎯 <b>TRANSFORMATIONAL EPICENTER</b><br/>Unique Integration of All Four Segments"]
    end

    style TAM fill:#f7fafc,stroke:#1a365d,stroke-width:2px
    style T1 fill:#ebf8ff,stroke:#2c5282
    style T2 fill:#e6fffa,stroke:#319795
    style T3 fill:#faf5ff,stroke:#805ad5
    style T4 fill:#fefcbf,stroke:#d69e2e
    style TE fill:#c6f6d5,stroke:#276749,stroke-width:3px
```
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph MOAT["🏰 COMPETITIVE MOAT: WHY COMPETITORS CAN'T FOLLOW"]
        direction TB

        TE["⭐ TRANSFORMATIONAL EPICENTER<br/><i>Full Integration</i>"]

        subgraph BARRIERS["STRUCTURAL BARRIERS"]
            direction LR
            B1["🏥 <b>Medical Clinics</b><br/>Won't touch<br/>plant medicine"]
            B2["🏨 <b>Luxury Resorts</b><br/>Lack medical<br/>expertise"]
            B3["🌿 <b>Plant Medicine</b><br/>Can't afford<br/>luxury infrastructure"]
            B4["⚡ <b>Biohacking</b><br/>Transactional<br/>not transformational"]
        end
    ...
    style B1 fill:#fff5f5,stroke:#c53030
    style B2 fill:#fff5f5,stroke:#c53030
    style B3 fill:#fff5f5,stroke:#c53030
    style B4 fill:#fff5f5,stroke:#c53030
```
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph PORTFOLIO["🏘️ DUAL PROPERTY PORTFOLIO STRATEGY"]
        direction TB

        subgraph ALEA["🏨 HOTEL ALEA TULUM"]
            A1["📍 Bahia de Soliman"]
        ...
        subgraph CARACOL["🏛️ HACIENDA CARACOL"]
            C1["📍 Soliman Bay"]
        ...
        SYNERGY["🔗 <b>COMBINED SYNERGIES</b><br/>31 Rooms | 25 Treatment Beds | 456 Guests<br/><b>$32.95M Total | 78% Blended IRR</b>"]
    end

    style ALEA fill:#ebf8ff,stroke:#2c5282,stroke-width:2px
    style CARACOL fill:#faf5ff,stroke:#805ad5,stroke-width:2px
    style SYNERGY fill:#c6f6d5,stroke:#276749,stroke-width:3px
```
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph PROGRAMS["🌿 TRANSFORMATION PROGRAM STRUCTURE"]
        direction TB

        subgraph TIERS["PRICING TIERS"]
            direction LR
            HNW["💎 <b>HNW TIER</b><br/>Hotel Alea Tulum<br/>$2,200-$2,500/day"]
            UHNW["👑 <b>U-HNW TIER</b><br/>Hacienda Caracol<br/>$2,992-$3,400/day<br/><i>(1.36x Premium)</i>"]
        end

        subgraph DURATIONS["PROGRAM DURATIONS"]
            direction LR
            D7["7-Day<br/><b>Reset</b><br/>20% mix"]
            D14["14-Day<br/><b>Interruption</b><br/>35% mix"]
            D21["21-Day<br/><b>Recalibration</b><br/>30% mix"]
            D28["28-Day<br/><b>Transformation</b><br/>15% mix"]
        end

        subgraph ADDONS["ADD-ON REVENUE (+28%)"]
            direction LR
            A1["⚡ Bio-Opt<br/>+15%"]
            A2["💊 Products<br/>+4%"]
            A3["📱 Post-Care<br/>+6%"]
        ...
        TIERS --> DURATIONS --> ADDONS

        AVG["💰 <b>AVERAGE REVENUE/GUEST</b><br/>HNW: $48,138 | U-HNW: $65,476<br/>Blended: <b>$54,050</b>"]

        ADDONS --> AVG
    end

    style HNW fill:#ebf8ff,stroke:#2c5282
    style UHNW fill:#faf5ff,stroke:#805ad5,stroke-width:2px
    style D7 fill:#c6f6d5,stroke:#276749
    style D14 fill:#c6f6d5,stroke:#276749,stroke-width:2px
    style D21 fill:#c6f6d5,stroke:#276749
    style D28 fill:#c6f6d5,stroke:#276749
    style AVG fill:#1a365d,stroke:#2c5282,stroke-width:2px,color:#fff
```
...
xychart-beta
    ...
    y-axis "Revenue ($ Millions)" 0 --> 25
    bar [11.9, 17.0, 20.3, 22.0, 23.2]
    line [11.9, 17.0, 20.3, 22.0, 23.2]
```

```mermaid
%%{init: {'theme': 'base'}}%%
flowchart LR
    subgraph GROWTH["📈 5-YEAR REVENUE TRAJECTORY"]
        Y1["Year 1<br/><b>$11.9M</b><br/>Launch"]
        Y2["Year 2<br/><b>$17.0M</b><br/>+42%"]
        Y3["Year 3<br/><b>$20.3M</b><br/>+20%"]
        Y4["Year 4<br/><b>$22.0M</b><br/>+8%"]
        Y5["Year 5<br/><b>$23.2M</b><br/>+5%"]

        Y1 -->|🚀| Y2 -->|📈| Y3 -->|📊| Y4 -->|✅| Y5
    end

    TOTAL["💰 <b>5-YEAR TOTAL</b><br/>$94.45M"]
    Y5 --> TOTAL

    style Y1 fill:#fed7d7,stroke:#c53030
    style Y2 fill:#feebc8,stroke:#d69e2e
    style Y3 fill:#faf5ff,stroke:#805ad5
    style Y4 fill:#e6fffa,stroke:#319795
    style Y5 fill:#c6f6d5,stroke:#276749
    style TOTAL fill:#1a365d,stroke:#2c5282,color:#fff
```
...
flowchart TB
    subgraph RETURNS["💎 INVESTMENT TO EXIT VALUE CREATION"]
        ...
        subgraph OPS["5-YEAR OPERATIONS"]
            direction LR
            REV["📊 Revenue<br/>$94.45M"]
            EBITDA["💵 EBITDA<br/>$36.14M"]
            NI["✅ Net Income<br/>$20.33M"]
        end

        INV --> OPS

        subgraph EXIT["EXIT VALUATION"]
            direction LR
            MULT["5.5x EBITDA<br/>Multiple"]
            EV["🎯 Exit Value<br/><b>$73.87M</b>"]
        end
    ...
    style REV fill:#ebf8ff,stroke:#2c5282
    style EBITDA fill:#e6fffa,stroke:#319795
    style NI fill:#c6f6d5,stroke:#276749
    style EV fill:#faf5ff,stroke:#805ad5,stroke-width:2px
    style IRR fill:#fefcbf,stroke:#d69e2e
    style MOIC fill:#fefcbf,stroke:#d69e2e
```
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph METHODS["🎯 9-METHODOLOGY VALUATION FRAMEWORK"]
        direction TB

        subgraph PRIMARY["PRIMARY METHODS (60% Weight)"]
            direction LR
            SC["📋 Scorecard<br/>$38.75M<br/><b>20%</b>"]
            CL["✅ Checklist<br/>$45.00M<br/><b>20%</b>"]
            DCF["💰 DCF Growth<br/>$48.50M<br/><b>20%</b>"]
        end

        subgraph SECONDARY["SECONDARY METHODS (20% Weight)"]
            direction LR
            TVC["📊 Tiered VC<br/>$55.00M<br/><b>10%</b>"]
            DCFM["🔢 DCF Multiples<br/>$44.25M<br/><b>10%</b>"]
        end

        subgraph SUPPORT["SUPPORTING METHODS (20% Weight)"]
            direction LR
            COST["🏗️ Cost<br/>$32.95M<br/><i>5%</i>"]
            VCR["📈 VC Rev<br/>$42.00M<br/><i>7%</i>"]
            VCE["💵 VC EBITDA<br/>$39.00M<br/><i>5%</i>"]
            VCN["✅ VC NI<br/>$30.00M<br/><i>3%</i>"]
        end
        ...
        WEIGHTED["⭐ <b>WEIGHTED VALUATION</b><br/><b>$41,812,500</b>"]
    end

    style SC fill:#c6f6d5,stroke:#276749
    style CL fill:#c6f6d5,stroke:#276749
    style DCF fill:#c6f6d5,stroke:#276749
    style TVC fill:#e6fffa,stroke:#319795
    style DCFM fill:#e6fffa,stroke:#319795
    style COST fill:#faf5ff,stroke:#805ad5
    style VCR fill:#faf5ff,stroke:#805ad5
    style VCE fill:#faf5ff,stroke:#805ad5
    style VCN fill:#faf5ff,stroke:#805ad5
    style WEIGHTED fill:#1a365d,stroke:#2c5282,stroke-width:3px,color:#fff
```

```mermaid
%%{init: {'theme': 'base'}}%%
pie showData title Valuation Methodology Weights
    "Scorecard (20%)" : 20
    "Checklist (20%)" : 20
    "DCF Growth (20%)" : 20
    "Tiered VC (10%)" : 10
...
|-------|-------------|-------|
| Low Bound | Central × 0.80 | $33,450,000 |
| **Central Value** | 9-Method Weighted Avg | **$41,812,500** |
| High Bound | Central × 1.40 | $58,537,500 |
...
```mermaid
%%{init: {'theme': 'base'}}%%
pie showData title Use of Funds Allocation ($32.95M)
    "Property Acquisition (36.4%)" : 11983000
    "Construction (29.0%)" : 9550000
    "Working Capital (8.2%)" : 2700000
    "Equipment (8.5%)" : 2800000
    "Contingency (7.2%)" : 2382750
    "FF&E (5.8%)" : 1900000
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph TEAM["👥 ORGANIZATIONAL STRUCTURE (52 FTEs)"]
        direction TB

        subgraph CLINICAL["🏥 CLINICAL TEAM (24 FTEs)"]
            direction LR
            MED["Medical<br/>12 FTEs<br/>$960K"]
            THER["Therapeutic<br/>8 FTEs<br/>$520K"]
            BIO["Bio-Opt<br/>4 FTEs<br/>$280K"]
        end

        subgraph HOSPITALITY["🏨 HOSPITALITY TEAM (18 FTEs)"]
            direction LR
            FB["F&B, Housekeeping<br/>Concierge<br/>$720K"]
        end

        subgraph SUPPORT["⚙️ SUPPORT TEAM (10 FTEs)"]
            direction LR
            ADMIN["Admin<br/>6 FTEs<br/>$420K"]
            SEC["Security<br/>4 FTEs<br/>$180K"]
        end
        ...
        GUEST["👤 <b>GUEST EXPERIENCE</b><br/>2.08:1 Staff Ratio<br/>$3.08M Total Personnel"]
    end

    style MED fill:#ebf8ff,stroke:#2c5282
    style THER fill:#e6fffa,stroke:#319795
    style BIO fill:#faf5ff,stroke:#805ad5
    style FB fill:#fefcbf,stroke:#d69e2e
    style ADMIN fill:#fed7d7,stroke:#c53030
    style SEC fill:#f0fff4,stroke:#38a169
    style GUEST fill:#1a365d,stroke:#2c5282,stroke-width:2px,color:#fff
```

```mermaid
%%{init: {'theme': 'base'}}%%
pie showData title Personnel Investment by Department
    "Medical (31%)" : 960000
    "Hospitality (23%)" : 720000
    "Therapeutic (17%)" : 520000
    "Admin (14%)" : 420000
    "Bio-Opt (9%)" : 280000
    "Security (6%)" : 180000
```
...
%%{init: {'theme': 'base'}}%%
xychart-beta
    title "Competitive Revenue Comparison (5-Year Projection)"
    x-axis ["SHA Wellness", "Clinique La Prairie", "Beond", "TE Portfolio"]
...
%%{init: {'theme': 'base'}}%%
flowchart LR
    subgraph BENCHMARK["📊 COMPETITIVE BENCHMARKING"]
        direction TB

        subgraph ESTABLISHED["🏛️ ESTABLISHED PLAYERS"]
            L["Lanserhof<br/>$120M → $212M<br/>12% CAGR"]
            CLP["Clinique La Prairie<br/>$80M → $129M<br/>10% CAGR"]
            SHA["SHA Wellness<br/>$45M → $66M<br/>8% CAGR"]
        end

        subgraph EMERGING["🌱 EMERGING PLAYERS"]
            B["Beond Ibogaine<br/>$8M → $24M<br/>25% CAGR"]
            TE["⭐ <b>TE Portfolio</b><br/><b>$12M → $23M</b><br/><b>18% CAGR</b>"]
        end

        L & CLP & SHA -.->|Market Leaders| VALIDATE
        B & TE -.->|High Growth| VALIDATE

        VALIDATE["✅ TE Growth Trajectory<br/>Validates Business Model"]
    end

    style TE fill:#c6f6d5,stroke:#276749,stroke-width:3px
    style VALIDATE fill:#1a365d,stroke:#2c5282,color:#fff
```
...
| **Year 5 Exit** | 20% | 78% | 32% |
| **Year 7 Exit** | 22% | 27% | 34% |

```mermaid
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph SENSITIVITY["📊 IRR SENSITIVITY ANALYSIS"]
        direction TB
        ...
        subgraph MATRIX["TIMELINE × MULTIPLE MATRIX"]
            ...
            Y5["<b>Year 5 Exit</b><br/>20% | <b>78%</b> | 32%"]
            Y7["<b>Year 7 Exit</b><br/>22% | 27% | 34%"]
        end

        BASE["⭐ BASE CASE<br/>Year 5 × 5.5x = <b>78% IRR</b>"]
...
**Scorecard Valuation:** $25,000,000 × 1.55 = **$38,750,000**

```mermaid
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph SCORECARD["📋 SCORECARD METHOD BREAKDOWN"]
        direction TB
...
**Checklist Valuation:** $60,000,000 × 0.75 (adjusted) = **$45,000,000**
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph VCMETHODS["📊 VENTURE CAPITAL METHODS SUMMARY"]
        direction TB

        subgraph METHODS["FOUR VC APPROACHES"]
            direction LR
            VCR["💵 <b>VC Revenue</b><br/>$42M<br/><i>2.5x Rev Multiple</i>"]
            VCE["📈 <b>VC EBITDA</b><br/>$39M<br/><i>5.5x EBITDA Multiple</i>"]
            VCN["✅ <b>VC Net Income</b><br/>$30M<br/><i>12x P/E Multiple</i>"]
            VCT["🎯 <b>Tiered VC</b><br/>$55M<br/><i>Recurring + Add-On</i>"]
        end

        RANGE["📊 <b>VC VALUATION RANGE</b><br/>$30M - $55M<br/>Average: <b>$41.5M</b>"]
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph WACC["📊 DISCOUNT RATE BUILD-UP (WACC: 28%)"]
        direction LR
...
| Terminal Value | $9,444,655 × (1.03) ÷ (0.28 - 0.03) |
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph DCF["💰 DCF VALUATION WATERFALL"]
        direction TB
...
| PV of Terminal Value | $53,870,603 × 0.291 |
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph PNL["💰 YEAR 5 P&L WATERFALL"]
        direction TB

        REV["📊 <b>REVENUE</b><br/>$23,157,598<br/>100%"]
        COGS["🏭 COGS<br/>-$6,020,976<br/>-26%"]
        GP["💵 <b>GROSS PROFIT</b><br/>$17,136,622<br/>74%"]
        OPEX["⚙️ Operating Expenses<br/>-$7,341,967<br/>-32%"]
        EBITDA["📈 <b>EBITDA</b><br/>$9,794,655<br/>42.3%"]
        DA["📉 D&A + Interest<br/>-$1,289,288"]
        TAX["🏛️ Taxes<br/>-$3,274,566"]
        NI["✅ <b>NET INCOME</b><br/>$5,230,801<br/>22.6%"]
...
%%{init: {'theme': 'base'}}%%
flowchart LR
    subgraph CASHFLOW["💵 CASH ACCUMULATION OVER 5 YEARS"]
        direction LR
...
flowchart TB
    subgraph POSITION["🎯 UNIQUE MARKET POSITIONING"]
        ...
        subgraph OTHERS["OTHER MARKET PLAYERS"]
            direction LR
            MC["🏥 Medical Clinics<br/>Clinique La Prairie, SHA<br/><i>High Medical, Moderate Luxury<br/>No Plant Medicine</i>"]
            LR["🏨 Luxury Resorts<br/>Aman, Six Senses<br/><i>High Luxury, Surface Wellness<br/>No Medical</i>"]
            BC["⚡ Biohacking<br/>Upgrade Labs<br/><i>Low Luxury, Surface<br/>Transactional Model</i>"]
            PM["🌿 Plant Medicine<br/>Beond, Rythmia<br/><i>Medical Focus<br/>Limited Luxury</i>"]
        end
...
%%{init: {'theme': 'base'}}%%
flowchart LR
    subgraph JOURNEY["🚀 5-YEAR MILESTONE PATHWAY"]
        direction LR

        Y1["📍 <b>YEAR 1</b><br/>Launch<br/>$11.9M<br/>230 guests"]
        Y2["📈 <b>YEAR 2</b><br/>Scale<br/>$17.0M<br/>340 guests"]
        Y3["⚖️ <b>YEAR 3</b><br/>Stabilize<br/>$20.3M<br/>420 guests"]
        Y4["🔧 <b>YEAR 4</b><br/>Optimize<br/>$22.0M<br/>450 guests"]
        Y5["🌟 <b>YEAR 5</b><br/>Expand<br/>$23.2M<br/>456 guests"]
...
flowchart TB
    subgraph RISK["⚠️ RISK ASSESSMENT MATRIX"]
        ...
        MITIGATION["✅ <b>ALL RISKS MITIGATED</b><br/>Comprehensive strategies in place"]
...
%%{init: {'theme': 'base'}}%%
flowchart TB
    subgraph UPSIDE["📊 VALUATION UPSIDE POTENTIAL"]
        direction TB
...
flowchart LR
    subgraph TAGLINE[""]
        direction LR
        MISSION["🌿 <i>Bringing the lost travellers back home<br/>to the garden of their hearts and soul</i> 🌿"]
    end
