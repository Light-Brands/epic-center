...
| **Commitment Fee** | None |
| **Exit Fee** | None |
| **Prepayment** | Open at any time. 6-month makewhole during months 1-6 (guarantees lender minimum $450,000 in interest), then open at par thereafter. 30 days' notice. |
