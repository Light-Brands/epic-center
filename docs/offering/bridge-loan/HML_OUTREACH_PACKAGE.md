...
## Senior Secured Bridge Loan Opportunity

**USD $10,000,000** | **9.00% per annum** | **36 Months** | **Interest-only, quarterly**
...
**Name:** Rancho Paraiso Oasis (to be repositioned as the Transformational Epicenter)
**Address:** Calle Perico Lts 79-80, Av Las Palmas, Akumal, Tulum, Q.R. 77776, Mexico
**Land area:** 45,000 m² across 9 contiguous lots (approximately 11 acres)
**Improvements:** Main house, guest houses, 16 bedrooms, cenote-fed pool, underground cavern lounge, spa, gym, walled compound, staff infrastructure, full utilities and roads
**Use profile:** Luxury wellness compound, configurable for private estate, boutique hotel, or retreat operations
**Prior capital deployed:** Over USD $25,000,000 into land, construction, and soft costs

The Property is located in the Akumal corridor of the Riviera Maya, 30 minutes north of Tulum center and 45 minutes south of the new Tulum International Airport. It sits in one of the most established luxury hospitality markets in Mexico, with direct exposure to the Tulum-Akumal wellness tourism demand curve.

**Current public listing:** The Property is actively listed for sale on Christie's International Real Estate Mexico (ID 047661), JamesEdition, Properstar, and Riviera Maya Real Estate Group at USD $11,900,000. The listing serves as the market-value anchor for this financing.

---

## Market Value Validation

The $11.9M market value is independently validated by **two Christie's International Real Estate Mexico listings at the same price point**:

| Comparable | Asking | Bedrooms | Source |
|---|---|---|---|
| **Rancho Paraiso Oasis** (subject) | $11,900,000 | 16 | [Christie's](https://www.christiesrealestate.com/homes/mexico/akumal/rancho-paraiso-oasis-akumal-mexico-77776/047661/) |
| **Casa Luna** (Region 15, Tulum) | $11,900,000 | 12-13 | [Christie's Mexico](https://www.christiesrealestatemexico.com/listings/for-sale/tulum/house/casa-luna/) |

Casa Luna is a 13-bedroom, 19-bath luxury villa in Tulum Region 15 with a comparable amenity stack (pool, multiple jacuzzis, gym, cold plunge, steam room, yoga room, club). It is smaller on both land and bedroom count than the subject. The convergence of two Christie's Mexico luxury listings at exactly $11,900,000 represents a tight and defensible market anchor. A formal third-party appraisal ("avalúo comercial") can be commissioned during diligence.

Full comparable sales research and valuation methodology is available in the data room under NDA.
...
- Full rights, title, and interests in the Property, improvements, fixtures, and appurtenant rights

### Additional Security
- Pledge of the fideicomisario beneficial interest in the Fideicomiso
- Assignment of all insurance policies and proceeds, with Lender as loss payee
...
- Optional corporate or personal guarantees, subject to lender preference
...
- Events-of-default package with 30-day cure periods on covenant breaches
- Default interest rate of note rate plus 4.00% per annum
...
| Metric | Amount |
|---|---|
| Market Value (Christie's public listing, validated by Casa Luna comp) | $11,900,000 |
...
The $11.9M market value is anchored to the Christie's public listing and independently validated by the Casa Luna comparable at the same price point. The $25,000,000+ of prior construction capital embedded in the asset (main house, guest house, cenote pool, cavern lounge, spa, gym, 16 bedrooms, full infrastructure) is retained as a replacement-cost backstop sitting beneath the market value. Third-party appraisal and formal broker opinions of value available on engagement.
...
- **Diligence materials ready.** The data room is populated. Title, permits, property overview, and sponsor materials can be delivered to the lender on day 0.
- **Relationship lender preferred.** A lender with an existing capability to underwrite cross-border Mexican secured bridges and the authority to commit without a multi-week credit committee process is required for this timeline.

---

## Diligence Materials (Available Under NDA)

Upon NDA execution, the following materials are available for lender review:

- **Full draft term sheet and loan agreement outline** (prepared for attorney review on both sides)
- **Comparable sales research and valuation memo** (filtered comp set, $11.9M twin-anchor validation)
- **Property overview package** (photographs, site plans, amenity inventory)
- **Title and fideicomiso documentation**
- **Permits and regulatory status summary**
- **Sponsor overview and team bios**
- **Use of proceeds detail and project budget**
- **Projected operating plan for post-acquisition period**

A formal Mexican appraisal ("avalúo comercial") can be commissioned and delivered during diligence at sponsor cost.
...
This document is a private opportunity summary prepared for qualified lenders. It does not constitute an offer to sell or a solicitation of an offer to buy any security or financial instrument, and it is not an offer of financing. All terms are indicative and subject to definitive documentation, mutual due diligence, legal review, and customary closing conditions.
...
*Transformational Epicenter | Senior Secured Bridge Loan | April 2026*
