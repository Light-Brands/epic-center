...
## Seller-Inclusive Investment Strategies
...
| **Risk of Conventional Offer** | A clean cash offer feels like loss. A structured deal that honors his contribution feels like evolution. |

### 2.2 Strategic Psychology
...
All strategies are grounded in the verified financial model (Google Sheets: `1Z0_N_V2gM-0rpW3IP9oRO12nmj51XwcTV_9R9fNsyWo`) and supporting data room documents.

### 3.1 Property and Capital
...
| Technology | $750,000 | Dashboard tab |
| Contingency | $847,500 | Dashboard tab |

### 3.2 Revenue and Profitability (Base Case)
...
> **Source:** Investment Returns tab, Valuation Report (Doc 22)

### 3.4 Cash Flow Available for Seller Debt Service

This is the critical number for seller financing feasibility. The project generates substantial free cash flow from Year 1 onward.

| Year | Cash from Operations | After Expansion CapEx | After Maintenance CapEx | **Free Cash Flow** |
|------|---------------------|----------------------|------------------------|-------------------|
| Year 1 | $3,204,403 | $3,204,403 | $3,204,403 | **$3,204,403** |
| Year 2 | $7,859,605 | $5,609,605 | $5,359,605 | **$5,359,605** |
| Year 3 | $11,076,962 | $9,276,962 | $8,976,962 | **$8,976,962** |
| Year 4 | $12,969,817 | $11,619,817 | $11,269,817 | **$11,269,817** |
| Year 5 | $14,532,595 | $13,182,595 | $12,782,595 | **$12,782,595** |
| **5-Year Total** | **$49,643,382** | | | **$41,593,382** |

> **Source:** Cash Flow tab

**Debt Service Coverage Analysis:**

Even with $8M in seller financing at 8% ($640K annual interest), Year 1 FCF of $3.2M provides a **5.0x debt service coverage ratio (DSCR)**. By Year 3, DSCR exceeds **14x**. The project can comfortably service seller debt from operations without external refinancing.

---

## 4. Non-Negotiable Principles

These principles apply across all three strategies. They are absolute.

### 4.1 Founder Control

| Domain | Requirement |
|--------|------------|
| Vision & Strategy | 100% founder authority; no seller veto on direction |
| Operations | 100% founder authority; seller has no management rights |
| IP, AI, Brand, Data, Protocols | Held in TE Wellness Holdings (Cayman); outside all seller instruments |
| Hiring & Personnel | 100% founder authority |
| Expansion Decisions | 100% founder authority |
...
| Allowed | Not Allowed |
|---------|------------|
| Non-controlling minority RE equity | Controlling interest in any entity |
| Profit participation in OpCo (economic right only) | Equity in TE Wellness Holdings above 5% |
| Advisory or honorary board role | Operational decision-making authority |
| Named recognition on property | Veto rights over business decisions |
| Annual reporting and transparency | Access to proprietary IP, data, or protocols |
| First-lien security on property (for debt) | Security interest in IP or operating company assets |

### 4.4 Entity Structure Integration

All seller instruments are designed to integrate cleanly with the existing 10-entity architecture. The seller's participation attaches at the **TE Real Estate Holdings** level (for RE equity and debt) and at the **TE Wellness Holdings** level (for OpCo profit participation), both via clearly bounded instruments with no downstream control.

```
Panama PIF (ultimate asset protection)
  |
  └── 100% → Panamanian Holdings S.A. (intermediate holdco)
                |
                ├── ~70%+ → TE Wellness Holdings (Cayman) ← [OpCo profit participation here]
                |               └── 100% → TE Ops Mexico (medical operations)
                |
                ├── 90-100% → TE Real Estate Holdings ← [Seller equity + seller note here]
                |               ├── 100% → TE RE Acq & Dev Mexico, S.A. de C.V.
                |               |              └── Fideicomiso (50-year bank trust)
...
SELLER ENTRY POINTS:
  Seller Note    → Secured debt against TE Real Estate Holdings (first lien on property)
  Seller Equity  → Non-controlling minority in TE Real Estate Holdings
...
**The seller carries the majority of the purchase price as a secured note and retains a permanent, non-controlling minority stake in the real estate entity. He is the steward whose vision lives on in the land itself. His name is inscribed. His connection endures. His economics are attractive. His involvement is minimal.**

This strategy is designed for a seller who wants to remain emotionally connected but does not want operational involvement. He wants to know his property is in good hands, receive predictable income, and see his legacy honored.

---

### 5.1 Transaction Structure Overview

| Component | Detail |
|-----------|--------|
| **Purchase Price** | $10,500,000 (negotiated from $11.9M) |
| **Cash at Close** | $3,000,000 (from investor capital) |
| **Seller Note** | $7,500,000 secured promissory note |
...
|--------|--------|-------------|
| Investor capital (RE investors) | $3,000,000 | Seller (cash at close) |
| Seller financing (note) | $7,500,000 | Retained as secured obligation to seller |
| **Total to Seller** | **$10,500,000** | |

**Post-Closing Capital Deployment:**

| Component | Amount | Source |
|-----------|--------|--------|
| Property Acquisition | $10,500,000 | $3M cash + $7.5M seller note |
| Renovation & Conversion | $1,000,000 | Investor capital (OpCo investors) |
| Medical + Biohacking | $1,000,000 | Investor capital (OpCo investors) |
| Working Capital | $1,126,000 | Investor capital (OpCo investors) |
| Technology | $750,000 | Investor capital (OpCo investors) |
| Contingency | $847,500 | Investor capital (OpCo investors) |
| Pre-Opening | $200,000 | Investor capital (OpCo investors) |
| **Total Capital Deployed** | **$15,423,500** | |

**Total Raise Required:** ~$12.4M from investors ($3M RE + ~$4.9M OpCo + remaining via blended instruments)

### 5.3 Seller Note Terms
...
### 5.4 Seller Note Cash Flow to Seller

| Year | Payment Type | Annual Payment | Cumulative |
|------|-------------|---------------|------------|
| Year 1 | Interest only | $562,500 | $562,500 |
| Year 2 | Interest only | $562,500 | $1,125,000 |
| Year 3 | Principal + Interest (amortizing) | ~$1,800,000 | $2,925,000 |
| Year 4 | Principal + Interest (amortizing) | ~$1,800,000 | $4,725,000 |
| Year 5 | Balloon (remaining principal + interest) | ~$4,200,000 | $8,925,000 |

**Total Note Payments Over 5 Years:** ~$8,925,000 on $7,500,000 principal (19% total return)

**DSCR Analysis:**

| Year | Free Cash Flow | Note Payment | DSCR |
|------|---------------|-------------|------|
| Year 1 | $3,204,403 | $562,500 | **5.7x** |
| Year 2 | $5,359,605 | $562,500 | **9.5x** |
| Year 3 | $8,976,962 | $1,800,000 | **5.0x** |
| Year 4 | $11,269,817 | $1,800,000 | **6.3x** |
| Year 5 | $12,782,595 | $4,200,000 | **3.0x** |

The project comfortably services the seller note at all times. Year 5 balloon can be funded from retained cash ($26.3M cumulative ending cash per Cash Flow tab) or conventional refinancing.

### 5.5 Seller Legacy Equity (10%)

| Term | Detail |
|------|--------|
| **Stake** | 10% non-controlling interest in TE Real Estate Holdings |
| **Voting Rights** | None (non-voting units) |
...
| Annual independent appraisal | Ongoing LTV monitoring |
| 10% equity provides alignment | Seller benefits from property appreciation alongside founders |
| Tag-along rights | If founders sell the RE entity, seller participates on same terms |

### 5.9 Emotional and Legacy Framing
...
### 6.1 Transaction Structure Overview
...
| **Default Provisions** | 90-day cure period; forced sale right |
| **Financial Covenant** | Minimum 1.5x DSCR |

### 6.4 Profit Participation Terms
...
### 6.5 Combined Seller Cash Flows (Note + Profit Participation)

**Seller Note Payments:**

| Year | Payment Type | Annual Payment |
|------|-------------|---------------|
| Year 1 | Interest only | $640,000 |
| Year 2 | Interest + beginning amortization | $1,100,000 |
| Year 3 | Principal + Interest (amortizing) | ~$2,200,000 |
| Year 4 | Principal + Interest (amortizing) | ~$2,200,000 |
| Year 5 | Balloon (remaining principal + interest) | ~$3,800,000 |
| **5-Year Note Total** | | **~$9,940,000** |

**Profit Participation Payments (4% of EBITDA):**

| Year | EBITDA (Base Case) | 4% Participation | Cumulative |
|------|-------------------|-----------------|------------|
| Year 1 | $4,301,800 | $0 (ramp period) | $0 |
| Year 2 | $10,902,089 | $436,084 | $436,084 |
...
| Profit Participation Impact | 4% of EBITDA; ~$436K/yr starting Year 2 |
| Buy-Out Option | Can extinguish profit participation at any time at PV |

### 6.8 Seller Protections

| Protection | Detail |
|-----------|--------|
| First-lien on property | Same as Strategy 1 |
| Quarterly interest payments | Income from Day 1 |
| Profit participation upside | If project succeeds, seller earns more |
| $5M cap provides certainty | Both sides know the maximum exposure |
| Semi-annual audited EBITDA | Transparency into operating performance |
| Forced sale right on default | Ultimate backstop |
| Buy-out right (at PV) | Liquidity option if seller wants to exit participation early |

### 6.9 Emotional and Legacy Framing
...
### 7.1 Transaction Structure Overview

| Component | Detail |
|-----------|--------|
| **Purchase Price** | $10,000,000 (negotiated from $11.9M) |
| **Cash at Close** | $2,000,000 (from investor capital) |
| **Seller Note** | $6,000,000 secured promissory note |
| **Seller Roll-Over (Renovation Investment)** | $2,000,000 reinvested into property renovations |
| **Seller RE Equity** | 8% non-controlling interest in TE Real Estate Holdings (earned via roll-over) |
...
| Source | Amount | Destination |
|--------|--------|-------------|
| Investor capital | $2,000,000 | Seller (cash at close) |
| Seller financing (note) | $6,000,000 | Retained as secured obligation |
| Seller roll-over (renovation) | $2,000,000 | Directly into renovation fund |
| **Total Transaction** | **$10,000,000** | |

**The $2M Roll-Over Mechanism:**

Instead of receiving $10M in total value at close ($2M cash + $8M note), the seller elects to reduce the note to $6M and redirect $2M back into the project as a renovation investment. In exchange, he receives:
- 8% non-controlling equity in TE Real Estate Holdings (valued against renovation contribution)
- 2.5% non-controlling equity in TE Wellness Holdings (sweat equity recognition)
...
### 7.4 Seller Equity Terms

**RE Equity (8% in TE Real Estate Holdings):**

| Term | Detail |
|------|--------|
| Stake | 8% non-controlling, non-voting units |
| Distribution Rights | 8% of RE entity distributions after debt service and reserves |
| Transfer | Subject to ROFR by founders |
| Buy-Out | Founders may purchase at FMV after Year 5 |
| Tag-Along | Yes |
| Information | Annual RE financial statement and appraisal |

**OpCo Equity (2.5% in TE Wellness Holdings):**

| Term | Detail |
|------|--------|
| Stake | 2.5% non-controlling, non-voting preferred units |
| Distribution Rights | 2.5% of OpCo distributions after preferred return to investors |
| Vesting | Immediate (fully vested at closing) |
| Transfer | Subject to ROFR by founders |
| Buy-Out | Founders may purchase at FMV after Year 5 |
| Tag-Along | Yes |
| Information | Quarterly financial summaries |

### 7.5 Advisory Board Role
...
### 7.6 Combined Seller Cash Flows

**Seller Note Payments:**

| Year | Payment Type | Annual Payment |
|------|-------------|---------------|
| Year 1 | Interest only | $420,000 |
| Year 2 | Interest only | $420,000 |
| Year 3 | Principal + Interest (amortizing) | ~$1,600,000 |
| Year 4 | Principal + Interest (amortizing) | ~$1,600,000 |
| Year 5 | Balloon (remaining principal + interest) | ~$3,100,000 |
| **5-Year Note Total** | | **~$7,140,000** |
...
| Protection | Detail |
|-----------|--------|
| First-lien on property | Same security as other strategies |
| Equity upside in both vehicles | Seller benefits from property AND operating success |
| $2M reinvestment directly improves property value | Seller's renovation capital enhances his own equity value |
| Advisory compensation provides income floor | $50K/year regardless of distributions |
| Annual on-site visit | Seller sees his property in person, annually |
| Tag-along on both equity positions | Protected in any sale event |
| Buy-out rights at FMV | Liquidity option after Year 5 |

### 7.10 Emotional and Legacy Framing
...
| **Seller Involvement** | Minimal | None | Active (advisory) |
| **Seller Equity** | RE only | None | RE + OpCo |
| **Founder RE Ownership** | 90% | 100% | 92% |
| **Founder OpCo Impact** | None | 4% EBITDA cost | 2.5% dilution |
| **Debt Service Burden** | Medium | Highest | Lowest |
| **Emotional Appeal to Seller** | High | Medium-High | Highest |
| **Negotiation Leverage** | Strong | Moderate | Very Strong |

### 8.3 Best Fit Analysis

| Seller Type | Recommended Strategy |
|-------------|---------------------|
| Wants passive income + emotional connection without involvement | **Strategy 1: Legacy Steward** |
| Wants maximum financial return + validation of his work | **Strategy 2: The Evolution** |
| Wants purpose, engagement, and to be part of something bigger | **Strategy 3: Partnership of Purpose** |
| Needs maximum cash at close | Strategy 1 (highest cash: $3M) |
| Price-sensitive / wants lowest headline price | Strategy 2 or 3 ($10M vs. $10.5M) |
| Tax-sensitive / wants to spread income | Strategy 2 (profit participation over 10 years) |
| Wants to impress peers / have a "story" | **Strategy 3** (he's an advisor/partner in a healing center) |

---

## 9. Seller Conversation Framework
...
Present ONE strategy at a time based on the seller's personality read. Do not present all three simultaneously.

- If the seller seems emotionally attached but low-energy: **Strategy 1**
- If the seller seems pragmatic and income-focused: **Strategy 2**
- If the seller seems restless, bored, and seeking purpose: **Strategy 3**

### 9.3 Handling Objections
...
## 10. Legal and Structural Integration

### 10.1 Fideicomiso Implications

The seller note is secured by a first-position lien on the property held within the fideicomiso (50-year renewable bank trust). Under Mexican law:
...
### 10.2 Entity-Level Documentation Required

| Document | Purpose | Responsible Party |
|----------|---------|------------------|
| Promissory Note | Seller financing terms; principal, interest, repayment schedule | Mexican counsel |
| Mortgage/Hipoteca Registration | First-lien security against property within fideicomiso | Mexican counsel + bank trustee |
| RE Holdings Operating Agreement Amendment | Seller equity participation (Strategies 1 and 3) | Corporate counsel |
| OpCo Equity Grant Agreement | Seller OpCo equity (Strategy 3) | Cayman counsel |
| Profit Participation Agreement | Seller EBITDA participation (Strategy 2) | Corporate counsel |
| Advisory Board Agreement | Advisory role terms (Strategy 3) | Corporate counsel |
| Fideicomiso Amendment | Consent for mortgage registration by bank trustee | Mexican counsel + bank trustee |
| Transfer Pricing Documentation | Intercompany flows supporting debt service | Tax counsel |

### 10.3 Tax Implications for the Seller

| Jurisdiction | Consideration |
|-------------|--------------|
| Mexico | Interest income from seller note is subject to Mexican withholding tax (varies by treaty). Profit participation may be classified as royalty or service income. Requires Mexican tax counsel review. |
| Seller's Home Jurisdiction | Capital gain on sale; installment sale treatment may apply to defer recognition. Interest income taxable as ordinary income. Equity grants may trigger income recognition. |
| Withholding | Mexico imposes withholding on interest payments to foreign lenders (25% default; reduced by applicable tax treaty). Structure should optimize for applicable treaties. |
...
### 11.1 Risks to Founders

| Risk | Probability | Impact | Mitigation |
|------|------------|--------|------------|
| Seller demands higher interest rate | Medium | Low | Budget supports up to 10% comfortably; DSCR remains >3x |
| Seller demands more equity | Medium | Medium | Hard cap at 15% RE and 5% OpCo; non-voting only |
| Seller exercises forced sale right | Very Low | High | DSCR coverage of 5.7x Year 1; 14x Year 3. Default is extremely unlikely. |
| Seller becomes problematic advisor (Strategy 3) | Low | Low | 90-day termination clause; advisory is non-binding |
| Seller's divorce proceedings complicate closing | Medium | Medium | Require clear title and divorce court approval before closing |
| Seller attempts to influence operations via equity | Low | Medium | Non-voting units; no management rights; clear operating agreement |

### 11.2 Risks to Seller
...
- [ ] Negotiate and execute promissory note, mortgage, equity agreements
...
- [ ] Issue equity certificates (if applicable)
- [ ] Fund cash at close from investor capital
- [ ] Begin renovation planning
- [ ] Send first "Legacy Steward" welcome communication to seller
...
| Document | Relevance |
|----------|-----------|
| Google Sheets Financial Model (`1Z0_N_V2gM-0rpW3IP9oRO12nmj51XwcTV_9R9fNsyWo`) | All financial projections, revenue, EBITDA, cash flow, investment returns |
...
| `docs/tax-structure/01-MASTER-STRUCTURE.md` | 7-entity global tax architecture |
| `docs/strategy/GLOBAL_TAX_OPTIMIZATION_STRATEGY.md` | Tax optimization framework |
| `docs/quintana-roo/MEXICO_REGULATORY_REQUIREMENTS.md` | Regulatory compliance roadmap |
