...
| **5-Year MOIC (incl. Exit)** | 7.8x (base), 5.5x (conservative) |
...
| Total Project Cost | $14,953,500 | $19,036,750 | $13,914,000 | $10,517,000 |
...
| 5-Year MOIC (incl. Exit) | **7.8x** | 2.61x | 1.85x | 0.65x |
...
| **Financial Returns** | 78% base-case IRR and 7.8x MOIC (incl. exit) represent the strongest risk-adjusted returns, producing $81.2M enterprise value at Year 5. $120.7M in projected 5-year revenue provides substantial cash generation. |
