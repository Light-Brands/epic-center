...
```mermaid
graph TB
    W1["WALL 1: CONSTITUTIONAL<br/>First Amendment<br/>Government cannot evaluate<br/>religious sincerity or doctrine<br/>Church autonomy prevents<br/>government intrusion"]
    ...
    style W1 fill:#0f3460,stroke:#e94560,color:#fff
    style W2 fill:#1a1a2e,stroke:#e94560,color:#fff
    style W3 fill:#533483,stroke:#ffd700,color:#fff
    style W4 fill:#16213e,stroke:#0f3460,color:#fff
    style W5 fill:#0a8754,stroke:#fff,color:#fff
```
...
**Panama PIF:** Beneficiary names are recorded in private regulations — never filed with any government. The US founder is NOT a beneficiary, eliminating CFC/GILTI/Subpart F/Form 5471 entirely. The PIF is an independent legal person under Panamanian Law 25 of 1995 — it has no "owner." It holds 100% of Panamanian Holdings S.A., which in turn holds all operating entity equity.
...
1. **Layer 1 — The S.A. corporate veil.** Panamanian Holdings S.A. is a standard corporation under the Panama Commercial Code. Piercing this veil requires proving fraud, illegality, or abuse of the corporate form under Panamanian law — a high bar in any jurisdiction, and particularly difficult in Panama where bearer shares (now immobilized) and nominee structures are longstanding commercial practice.
2. **Layer 2 — The PIF foundation.** Even if the S.A. veil is pierced, the adversary reaches the PIF — an independent legal person under Law 25 of 1995 with no "owner." The PIF's assets (i.e., the S.A. shares) cannot be seized by creditors of the PIF's beneficiaries, and the PIF cannot be compelled to distribute to any party. Panama does not recognize or enforce foreign court judgments against foundations.

This two-step barrier must be breached in sequence, in Panamanian courts, under Panamanian law. No reported case has successfully pierced both layers.
...
1. **Cost of attack exceeds recovery.** The IRS would need Cayman counsel, UAE tax counsel, Panamanian foundation specialists, Panamanian corporate counsel (for the S.A.), Mexican tax experts, First Amendment litigation counsel, and church tax specialists — simultaneously. A creditor targeting operating entity equity faces two separate Panamanian proceedings (S.A. corporate veil + PIF foundation) before reaching any assets.
