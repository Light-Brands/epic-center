...
graph TB
    ...
    W3["WALL 3: JURISDICTIONAL<br/>UAE sovereign tax law (0% QFZP)<br/>Panama PIF privacy (constitutional)<br/>Mexico OpCo: only local margin taxed"]

    W4["WALL 4: STRUCTURAL<br/>No entity controls another<br/>No circular cash flows<br/>Each entity has independent substance<br/>US founder is NOT an owner"]
...
**Panama PIF:** Beneficiary names are recorded in private regulations — never filed with any government. The US founder is NOT a beneficiary, eliminating CFC/GILTI/Subpart F/Form 5471 entirely.
...
TE satisfies all four. The UAE entity exists to create IP and operate a technology platform. The church exists to pursue a religious mission. The Mexico OpCo exists to deliver services. The PIF exists for asset protection. None is pretextual.
...
**Why TE is safe:** The US founder has zero ownership. The Panama PIF (owned by no one — it is an independent legal person) holds 100% of the UAE entity. The Canadian founder is the PIF Protector. The US founder is not a beneficiary, has no signatory authority, cannot direct distributions, and has no contractual right to PIF assets.
