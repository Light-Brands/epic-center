...
## 2. Why Cook Islands (Not Other Jurisdictions)

| Jurisdiction | Tax on International Income | Substance Required? | Asset Protection | OECD/FATF/EU Standing | Annual Cost | Verdict |
|---|---|---|---|---|---|---|
| **Cook Islands** | **0%** (unconditional for IBCs) | **No** — no employees, office, or local activity required | **#1 globally** (2-year statute of limitations, fraudulent transfer burden on creditor, no foreign judgment recognition) | Clean — not on EU blacklist, FATF compliant, TIEA signatory | ~$3-5K | **Selected** |
| BVI | 0% | No | Good but weaker than CI | EU blacklisted (removed 2023, watch list risk) | ~$2-4K | EU risk |
| Cayman | 0% | No (but increasing pressure) | Good | Clean, but OECD pressure increasing | ~$5-8K | Higher cost, more scrutiny |
| Panama IBC | 0% (territorial) | No | Good (different from PIF) | EU greylist risk | ~$2-3K | Having PIF + IBC in same jurisdiction looks like layering |
| Seychelles | 0% | No | Moderate | FATF greylist | ~$1-2K | Reputational risk |
| Nevis | 0% | No | Excellent | Limited banking relationships | ~$2-3K | Banking difficulty |

**Cook Islands wins on three dimensions:**

1. **Asset protection** — strongest in the world. The International Trusts Act 1984 (as amended) and the International Companies Act 1981-82 create a jurisdiction where: creditors face a 2-year statute of limitations from the date of transfer (not discovery), must prove fraudulent intent beyond reasonable doubt (not preponderance), and foreign court judgments are not recognized or enforceable.

2. **Clean international standing** — the Cook Islands is not on any EU blacklist or FATF greylist. It has signed Tax Information Exchange Agreements (TIEAs) and participates in CRS/AEOI. This is critical for banking relationships and intercompany transactions.

3. **Zero substance requirements** — unlike jurisdictions facing increasing economic substance demands (Cayman ESR, BVI Economic Substance Act), Cook Islands IBCs have no minimum substance requirements for international business. The entity can be a pure holding/IP/contracting vehicle.

---

## 3. IBC Formation and Governance
...
| **Formation cost** | ~$1,500-2,500 (agent fees + government fees) |

### Director Structure (Recommended)
...
|---|---|---|
| Annual return | Filed with Registrar via registered agent | Included in agent fee |
| Registered agent fee | Annual maintenance | ~$1,500-2,500/yr |
| Government annual fee | License renewal | ~$300-500/yr |
| Financial statements | Not required to be filed (keep internally for intercompany TP) | — |
| Audit | Not required | — |
...
|---|---|---|
| International consulting revenue | **0%** | IBC international income exemption |
| International SaaS/subscription revenue | **0%** | IBC international income exemption |
| Royalty income (from licensing IP) | **0%** | IBC international income exemption |
| Interest income | **0%** | IBC international income exemption |
| Capital gains | **0%** | IBC international income exemption |
| Dividends received | **0%** | IBC international income exemption |
...
### What Would Break the 0% Rate

| Action | Consequence |
|---|---|
| Conducting business with CI residents | Subject to CI domestic tax |
| Holding CI real property | Subject to CI property tax |
...
## 5. IP Ownership and Work-for-Hire Structure
...
| License | From | To | Type | Rate |
|---|---|---|---|---|
| Spiritual technology tools | CI IBC | Church | Royalty license | Arm's length (TP study) |
| Consciousness platforms | CI IBC | Church | Royalty license | Arm's length (TP study) |

**Church treatment:** Royalty income received by a 508(c)(1)(A) church is UBIT-exempt under IRC 512(b)(2), provided the underlying property is not debt-financed. The church licenses the tools for its spiritual mission — distributing consciousness technology to its congregation.

**Pricing:** The royalty rate must be defensible. Comparable rates for software/technology licensing to nonprofits typically range from 5-15% of revenue generated using the licensed technology. A TP study should establish the specific rate.
...
## 7. Banking and Payment Processing
...
| Method | Use Case |
|---|---|
| **Stripe (Singapore entity)** | SaaS subscriptions, recurring billing |
| **Wise Business** | International wire transfers, multi-currency receiving |
...
The Cook Islands is consistently ranked as the **#1 asset protection jurisdiction globally**. Key features:

| Feature | Detail |
|---|---|
| **Statute of limitations** | Creditors must bring fraudulent transfer claims within **2 years** of the transfer — not 2 years from discovery |
| **Burden of proof** | Creditor must prove fraudulent intent **beyond reasonable doubt** (criminal standard, not civil) |
| **Foreign judgments** | **Not recognized or enforceable.** Creditor must re-litigate in Cook Islands courts under Cook Islands law. |
| **Forum non conveniens** | CI courts will not decline jurisdiction in favor of foreign courts |
| **No contempt enforcement** | CI courts will not enforce foreign contempt orders compelling asset disclosure or transfer |
| **Duress defense** | If a settlor/director is compelled by a foreign court to repatriate assets, the Cook Islands trustee/director can legally refuse — the foreign order constitutes duress under CI law |
...
## 9. CRS/AEOI and International Reporting

The Cook Islands participates in the OECD Common Reporting Standard (CRS) and Automatic Exchange of Information (AEOI). This means:

| Reporting Element | Detail |
|---|---|
| **What is reported** | Account holder identity, account balance, income (interest, dividends, gross proceeds) |
...
| Item | Cost |
|---|---|
| Government registration fee | ~$300-500 |
| Registered agent setup fee | ~$1,000-1,500 |
| Legal review of Articles | ~$500-1,000 |
| Nominee director setup (if used) | ~$500-1,000 |
| Bank account opening (Singapore trip) | ~$1,500-2,500 (travel + bank fees) |
| **Total formation** | **~$3,800-6,500** |

### Annual Ongoing

| Item | Cost |
|---|---|
| Registered agent annual fee | ~$1,500-2,500 |
...
At even modest Light Brands revenue ($500K/year), the annual cost of maintaining the CI IBC (~$10K) represents a 2% overhead — while the entity generates a 0% tax rate on all international income. At $2M+ revenue, the overhead drops below 0.5%.
