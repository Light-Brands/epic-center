...
export const PROPERTY_FACTS = {
  ...
  brokerCommission: 1_600_000,    // Light Brands pays broker fee
...
export const SELLER_FINANCE_TERMS = {
  ...
  interestRate: 0.06,
  termYears: 6,
  brokerCommission: 1_600_000,  // Light Brands pays the broker fee
  brokerPaidBy: 'Light Brands',
  equityPercent: 0.10,
  reinvestment: 5_400_000,      // Jeff contributes $5.4M for operations
}
...
export const EQUITY = {
  percent: 0.10,
  reinvestment: 5_400_000,
  description: 'Jeff commits his property and $5.4M in operations capital. Light Brands pays the $1.6M broker fee. Jeff receives 10% equity in the enterprise.',
}
...
export const TOTAL_RETURN = {
  ...
  reinvestment: 5_400_000,
  netCash: 4_119_200,             // $9,519,200 - $5,400,000
  equityConservative: 44_500_000 * 0.10,   // $4,450,000
  equityBase: 76_800_000 * 0.10,            // $7,680,000
  equityFull: 175_000_000 * 0.10,           // $17,500,000
  totalConservative: 4_119_200 + 4_450_000,  // $8,569,200
  totalBase: 4_119_200 + 7_680_000,          // $11,799,200
  totalFull: 4_119_200 + 17_500_000,         // $21,619,200
}
...
// Light Brands pays $1.6M broker fee. Jeff gets 49% equity.
